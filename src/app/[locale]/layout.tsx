...
export async function generateMetadata({
  ...
  return {
    metadataBase: new URL(
      process.env.NEXT_PUBLIC_SITE_URL || 'https://academy.gmoplus.com'
    ),
    title: {
    ...
    alternates: {
      canonical: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://academy.gmoplus.com'}/${locale}`,
      languages: Object.fromEntries(
        routing.locales.map((l) => [
          l,
          `${process.env.NEXT_PUBLIC_SITE_URL || 'https://academy.gmoplus.com'}/${l}`,
        ])
      ),
    },
  };
